...
return /*must return the new process's program id(pid), must return pid-1(?idk if its return value of -1 or return value of pid minus 1)*/
}
...
return /*Returns true if successful, false is not*/
}
...
read(int fd, void *buffer, unsigned size)
{
    ...
    return /*Returns 0 is it has reached end of file, returns -1 if file could not be read*/
}
...
write(int fd, const void *buffer, unsigned size)
{
    ...
    return /*Returns the actually number written, or 0 is no bytes were written*/
}
